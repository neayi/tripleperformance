...
function getWikiComponents()
{
	...
	$components[] = array(	'dest' => $wiki_extensions_dir . '/HeadScript',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-HeadScript.git',
							'branch' => $wiki_version);
	...
	$components[] = array(	'dest' => $wiki_extensions_dir . '/Popups',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-Popups.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/Description2',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-Description2.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/Loops',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-Loops.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/Variables',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-Variables.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/PluggableAuth',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-PluggableAuth.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/Echo',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-Echo.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/DeleteBatch',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-DeleteBatch.git',
							'postinstall' => 'composer',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/Disambiguator',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-Disambiguator.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/VisualEditor',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-VisualEditor.git',
							'postinstall' => 'submodules',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/VEForAll',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-VEForAll.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/UploadWizard',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-UploadWizard.git',
							'branch' => $wiki_version);
	...
	$components[] = array(	'dest' => $wiki_extensions_dir . '/AdminLinks',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-AdminLinks.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/UrlShortener',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-UrlShortener.git',
							'branch' => $wiki_version);

	$components[] = array(	'dest' => $wiki_extensions_dir . '/ChangeAuthor',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-ChangeAuthor.git',
							'branch' => $wiki_version);
	...
	$components[] = array(	'dest' => $wiki_extensions_dir . '/OpenGraphMeta',
							'git' => 'https://github.com/wikimedia/mediawiki-extensions-OpenGraphMeta.git',
							'branch' => $wiki_version);
	...
	$components[] = array(	'dest' => $wiki_extensions_dir . '/Math',
							'git' => 'https://gerrit.wikimedia.org/r/mediawiki/extensions/Math',
							'branch' => $wiki_version);

	// Translation
	// $components[] = array(	'dest' => $wiki_extensions_dir . '/UniversalLanguageSelector',
	// 						'git' => 'https://gerrit.wikimedia.org/r/mediawiki/extensions/UniversalLanguageSelector.git',
	// 						'branch' => $wiki_version,
	// 						'postinstall' => 'composer');
	// $components[] = array(	'dest' => $wiki_extensions_dir . '/Translate',
	// 						'git' => 'https://github.com/wikimedia/mediawiki-extensions-Translate.git',
	// 						'branch' => $wiki_version,
	// 						'postinstall' => 'composer');
	...
	$components[] = array(	'dest' => $wiki_extensions_dir . '/Link_Attributes',
							'git' => 'https://github.com/neayi/mediawiki-extensions-Link_Attributes.git',
							'branch' => 'Neayi');
...
function checkout_project($aComponent, $bForceRemoveFolder = false)
{
	...
	if (!empty($aComponent['branch']))
		$cmd = 'git clone --depth 1 -q --branch ' . $aComponent['branch'] . ' ' . $aComponent['git'] . ' ' . root_web . $aComponent['dest'];
	else
