...
function getWikiComponents()
{
	...
	// Translation
	$components[] = array(	'dest' => $wiki_extensions_dir . '/ContentTranslation',
							'git' => '--branch '.$wiki_version.' https://gerrit.wikimedia.org/r/mediawiki/extensions/ContentTranslation.git',
							'branch' => $wiki_version,
							'postinstall' => 'composer');
