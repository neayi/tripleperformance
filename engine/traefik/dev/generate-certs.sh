...
openssl req -x509 -new -keyout ${TARGET}/root.key -out ${TARGET}/root.crt -config ${CONFIG}/root.cnf -passout pass:${PASS}
openssl req -nodes -new -keyout ${TARGET}/server.key -out ${TARGET}/server.csr -config ${CONFIG}/server.cnf
